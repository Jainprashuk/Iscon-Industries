...
<div className="my-8">.</div>
        ...
        <div className="mt-8 pt-4 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-3 justify-center">
...
<div className="rounded-md shadow-md sm:w-96 dark:bg-gray-900 dark:text-gray-100">
	<div className="flex items-center justify-between p-3">
		<div className="flex items-center space-x-2">
			...
			<div className="-space-y-1">
				<h2 className="text-sm font-semibold leadi">Poduct Name</h2>
				<span className="inline-block text-xs leadi dark:text-gray-400">Iscon - industries , Sanawad</span>
			</div>
		</div>
	...
	<div className="p-3">
		...
		<div className="flex flex-wrap items-center pt-3 pb-1">
			<div className="flex items-center space-x-2">
				...
				<span className="text-sm">Liked by
					<span className="font-semibold"> Ashish Jain </span>and
		...
		<div className="space-y-3">
			<p className="text-sm">
				<span className="text-base font-semibold"> Prashuk Jain</span> I have used this product , its Awesome..
			</p>
		</div>
	</div>
</div>
...
<div className="rounded-md shadow-md sm:w-96 dark:bg-gray-900 dark:text-gray-100">
	<div className="flex items-center justify-between p-3">
		<div className="flex items-center space-x-2">
			<img src="https://source.unsplash.com/50x50/?portrait" alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm dark:bg-gray-500 dark:border-gray-700" />
			<div className="-space-y-1">
				<h2 className="text-sm font-semibold leadi">Iscon - industries</h2>
				<span className="inline-block text-xs leadi dark:text-gray-400">Sanawad</span>
			</div>
		</div>
		<button title="Open options" type="button">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current">
