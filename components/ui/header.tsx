...
export default function Header() {
  return (
    <header className="fixed glassy w-full z-30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <li>
                <Link href="/" className="text-white hover:border-b-2 hover:border-purple-600  ml-6">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-white hover:border-b-2 hover:border-purple-600  ml-6">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/products" className="text-white hover:border-b-2 hover:border-purple-600 hover:border-b ml-6">
                  Our Products
                </Link>
              </li>
              <li>
